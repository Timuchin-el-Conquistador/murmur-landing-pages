...
import SurveyLogo from "../assets/images/rewards/logo-survey.svg"
import RepublicLogo from "../assets/images/destination/republic.svg"
import Blob1 from "../assets/images/destination/blob.png"
import Blob2 from "../assets/images/destination/blob1.png"
import Blob3 from "../assets/images/destination/blob2.png"
...
//available
import Available1 from  "../assets/images/destination/available1.png"
import Available2 from  "../assets/images/destination/available2.png"
import Available3 from  "../assets/images/destination/available3.png"
import Available4 from  "../assets/images/destination/available4.png"
import Available5 from  "../assets/images/destination/available5.png"
import Available6 from  "../assets/images/destination/available6.png"
import ArrowUp from  "../assets/images/destination/arrow-up.svg"
import StaticChart from  "../assets/images/destination/chart.png"
// css
import "../assets/styles/destination/index.css";
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <section className={styles.destination_section1}>
            <div className={styles.grow_sales}>
                <div className={styles.grow_content}>
                    <h2>Lorem ipsum dolor sit amet.</h2>
                    <h4>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id dui tempor id volutpat lorem ac massa morbi. Tellus feugiat turpis </h4>
            ...
            <img src={Blob1} alt="" className={styles.blob_img1}/>
            <img src={Blob2} alt="" className={styles.blob_img2}/>
            <img src={Blob3} alt="" className={styles.blob_img3}/>
        </section>
        ...
        <section className={styles.statistics}>
          <Container className={styles.stat_contain}>
            <h2 className={styles.title_h2}>Statistics</h2>
            <div className={styles.main_sub_txt}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi aenean dui, volutpat porttitor ipsum. Nulla egestas penatibus aliquam mauris.
            </div>
            <Row className={styles.static_row}>
              <Col md="4" xs="12" className={styles.static_col}>
                <div className={styles.stat_item}>
                  <p className={styles.stat_p}>Money we raised</p>
                  <div className={styles.stat_item_flex}>
                    <p>$139 650</p>
                    <span><img src={ArrowUp} alt="" />24%</span>
                  </div>
              ...
              <Col md="4" xs="12" className={styles.static_col}>
                <div className={styles.stat_item}>
                  ...
                  <div className={styles.stat_item_flex}>
                    <p>67 000+</p>
                    <span><img src={ArrowUp} alt="" />56%</span>
                  </div>
                  <span className={styles.stat_span}>Since last month</span>
                </div>
              </Col>
              ...
              <Col md="8" xs="12" className={styles.static_col}>
                <div className={styles.stat_item}>
                  <div className={styles.static_img_flex}>
                    <div className={styles.static_chart_info}>
                      <p>Number of impressions</p>
                      <span>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Arcu sagittis aenean.</span>
                    </div>
                    <div className={styles.static_chart_right}>
                      <div className={styles.stat_item_flex}>
                        <p>$139 650</p>
                        <span><img src={ArrowUp} alt="" />24%</span>
                      </div>
              ...
              <Col md="4" xs="12" className={styles.static_col}>
                <div className={styles.stat_item}>
                  <h5 className={styles.startups_number}>Number of IT Startups</h5>
                  <p className={styles.stat_inner_txt}>Number of Startups we adversite and number of startups that applied.</p>
                  <ul className={styles.stat_ul}>
                    <li>
                      <span>Number of Startups we adversite:</span>
                      <p>15</p>
                    </li>
                    <li>
                      <span>Number of Startups applied</span>
                      <p>263</p>
                    </li>
                  </ul>
                </div>
        ...
        <section className={styles.available_section}>
          <Container className={styles.available_contain}>
            <h2 className={styles.title_h2}>We currently avaiable at:</h2>
            <div className={styles.main_sub_txt}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi aenean dui, volutpat porttitor ipsum. Nulla egestas penatibus aliquam mauris.
            </div>
            <div className={styles.avaib_cover}>
              <Row className={styles.avaib_row}>
                <Col md="7" xs="6" className="avaib_col">
                  <div className={styles.avaib_item}>
                    <a href="#">
                      <img src={Available1} alt="" />
                    </a>
                    <div className={styles.avaib_layer}>
                      <span>Miami</span>
                    </div>
                  </div>
                </Col>
                <Col md="5" xs="6" className="avaib_col">
                  <div className={styles.avaib_item}>
                    <a href="#">
                      <img src={Available2} alt="" />
                    </a>
                    <div className={styles.avaib_layer}>
                ...
                <Col md="3" xs="6" className="avaib_col">
                  <div className={styles.avaib_item}>
                    <a href="#">
                      <img src={Available3} alt="" />
                    </a>
                    <div className={styles.avaib_layer}>
                ...
                <Row>
                  <Col md="12" xs="12">
                    <div className={styles.contact_left}>
                        ...
                        <p className={styles.dest_contact_p}>
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi aenean dui, volutpat porttitor ipsum. Nulla egestas penatibus aliquam mauris.
                        </p>
                        <a href="https://www.murmurcars.com/" className={styles.dest_con_btn}>Create Champanig 
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
