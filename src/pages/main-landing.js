    ...
    return (
      <React.Fragment>
            ...
            <div className={styles.main_top_info}>
              ...
              <div className={styles.tailored_left}>
                ...
                <p className={styles.tailored_p}>
                  ...
                  dui tempor id volutpat lorem ac massa morbi. Tellus feugiat
                  turpis{" "}
                </p>
                <a
              ...
              <Col md="4" xs="12">
                <div className={styles.our_tech_item}>
                  ...
                  <div className={styles.our_tech_txt}>
                    ...
                    Eleifend nulla ante congue feugiat felis augue.
                  </div>
                </div>
              </Col>
              <Col md="4" xs="12">
              ...
              <Col md="4" xs="12">
                <div className={styles.tech_bottom}>
                  ...
                  <p>
                    ...
                    vulputate amet tempor, quam laoreet sed nunc tempor. Mauris
                    varius turpis id feugiat pharetra.{" "}
                  </p>
                </div>
              </Col>
              <Col md="4" xs="12">
                <div className={styles.tech_bottom}>
                  ...
                  <p>
                    Benefit of such approach help you to better understand your
                    target audiences, target them where they go, use
                    demographics, location, behavior data to personalize ad, and
                    target people where they go by point of interest(places
                    ......
                  </p>
                </div>
              </Col>
              ...
              <Col md="7" xs="12" className={styles.testimonial_col}>
                <div className={styles.testimonial_item}>
                  ...
                  <div className={styles.testimonial_txt}>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Eget metus odio duis lorem elementum accumsan. Id accumsan
                    nunc pellentesque varius dui potenti vestibulum purus.
                    Bibendum a, nisi donec pharetra faucibus iaculis. Nulla nec
                    ac neque, ullamcorper adipiscing ipsum donec. Pretium et
                    pellentesque quis semper. Morbi accumsan, elit sed aliquet
                    donec tristique nisi dolor arcu. Praesent ut amet elit at
                    in. Mauris sagittis, nunc id nec faucibus semper viverra
                    nec. Nibh quam mollis arcu orci ullamcorper id suspendisse
                    massa. Morbi facilisis interdum purus consequat. Tellus
                    potenti nunc enim massa suspendisse aliquet. At aliquet ac
                    cras diam. Elementum, consectetur egestas massa neque,
                    tortor lorem.
                  </div>
                </div>
              </Col>
        ...
        <section className={styles.main_ab_testing}>
          <h2 className={styles.title_h2}>
            Meet with our A/B Testing Platform
          </h2>
          <div className={styles.main_sub_txt}>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget
            tincidunt turpis tincidunt eros, integer vitae. Velit viverra
              ...
              <Row className={styles.main_ab_row}>
                <Col md="5" xs="12">
                  <div className={styles.main_ab_txt}>
                    ...
                    <p>
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Dis quisque mi faucibus cursus est.
                    </p>
                  </div>
                </Col>
                <Col md="7" xs="12">
        ...
        <section className={styles.happy_street}>
          ...
          <Container className={styles.happy_container}>
            ...
            <div className={styles.happy_demo_txt}>
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eget
              tincidunt turpis tincidunt eros, integer vitae. Velit viverra
              accumsan a ut at sed est. Go to the Street IQ for more detailed
              information:
            </div>
            <div className="text-center">
              <Link to="/streetLanding" className={styles.view_demo_btn}>
                Try Free
                <svg
                  width="20"
                  height="20"
        ...
        <section className={styles.success_stories}>
          ...
          <div className={styles.success_stories_txt}>
            Read about some of the greatest stories about business like yours,
            that use Murmur
          </div>
        ...
        <section className={styles.get_tailored}>
          ...
          <div className={styles.main_tailored_txt}>
            ...
            pharetra est ut facilisis. Vel, sagittis platea euismod aliquam arcu
            pretium sed. Enim id risus feugiat magna.
          </div>
        ...
        <section className={styles.main_brand_slider}>
          ...
          <div className={styles.main_slider_txt}>
            ...
            volutpat et elementum adipiscing morbi. Dictumst eget pretium mauris
            laoreet ante. Sed sed euismod etiam vitae convallis nibh. Bibendum
            quisque egestas elementum in at nam gravida quam ornare.
          </div>
          <Brand_Slider />
        </section>
          ...
          <div className={styles.transform_ads}>
            <div className={styles.transform_cover}>
              <h4 className={styles.transform_ads_h4}>
                Transform your adversitings with progressive solutions
              </h4>
              <div className={styles.transform_ads_txt}>
                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                Fringilla libero, turpis fusce egestas mi sem morbi. Sed augue
                gravida blandit in senectus eget. Amet sollicitudin convallis
                vel blandit. Platea tincidunt convallis ante fusce accumsan
                volutpat. A consequat consectetur a, dolor ut amet.
              </div>
                  ...
                  <Col md="12" xs="12">
                    <div className={styles.contact_left}>
                      ...
                      <p className={styles.contact_p}>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                        Morbi aenean dui, volutpat porttitor ipsum. Nulla
                        egestas penatibus aliquam mauris.
                      </p>
                      <a
                        href="https://www.murmurcars.com/"
                        className={styles.create_champ_btn}
            ...
            <Row className={styles.street_footer_top}>
              <Col xs="12" md="3" className="footer_item">
                ...
                <p className={styles.ft_left_p}>
                  Helping founders to promote their growd funding campaigns
                </p>
              ...
              <Col xs="12" md="2" className="footer_item">
                ...
                <ul className={styles.footer_nav}>
                  <li>
                    <a href="https://www.murmurcars.com/">Investor DB</a>
                  </li>
                  <li>
                    <a href="https://www.murmurcars.com/">Community</a>
                  </li>
                  <li>
                    <a href="https://www.murmurcars.com/">Founder Tools</a>
                  </li>
                  <li>
                    <a href="https://www.murmurcars.com/">Startup Checklist</a>
                  </li>
                  <li>
                    <a href="https://www.murmurcars.com/">Privacy Policy</a>
                  </li>
                </ul>
              </Col>
              <Col xs="12" md="2" className="footer_item">
                ...
                <ul className={styles.footer_nav}>
                  <li>
                    <a href="https://www.murmurcars.com/">How to Raise?</a>
                  </li>
                  <li>
                    <a href="https://www.murmurcars.com/">Learn</a>
                  </li>
                  <li>
                    <a href="https://www.murmurcars.com/">Why Murmur?</a>
                  </li>
                </ul>
              </Col>
              <Col xs="12" md="2" className="footer_item">
                ...
                <ul className={styles.footer_nav}>
                  <li>
                    <a href="https://www.murmurcars.com/">About</a>
                  </li>
                  <li>
                    <a href="https://www.murmurcars.com/">Events</a>
                  </li>
                  <li>
                    <a href="https://www.murmurcars.com/">We’re hiring!</a>
                  </li>
                </ul>
              </Col>
              <Col xs="12" md="3" className="footer_item">
