        ...
        <Container id="main-container">
          <Row xs="2" className="main-row">
            ...
            <Col className="right-col" xs="7">
              <Button className="right-col-button">Create Campaigning</Button>
            </Col>
            <Col className="center-col">
              <h1>Takeover Streets, Grow Sales </h1>
              <p>
                We help any businesses to target their audiences where they go.
                Reach local audiences and drive results more effectively. Build
                awareness, acquire, convert, increase sales
              </p>
            </Col>
