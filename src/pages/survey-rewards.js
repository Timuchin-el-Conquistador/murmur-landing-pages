...
import Earn_Money from "../assets/images/rewards/earn_money.png"
//works icons
import Answer from "../assets/images/rewards/answer.svg"
import Download from "../assets/images/rewards/download.svg"
import Receive from "../assets/images/rewards/receive.svg"
import Money from "../assets/images/rewards/money.svg"
import Phone from "../assets/images/rewards/phone.png"
import Surveybg1 from "../assets/images/rewards/survey-bg1.png"
import Surveybg2 from "../assets/images/rewards/survey-bg2.png"
import Surveybg3 from "../assets/images/rewards/survey-bg3.png"
  ...
  render() {
    return (
      <React.Fragment>
        ...
        <section className={styles.earn_money}>
            <Container className={styles.earn_container}>
                <Row>
                    <Col md="6" xs="12">
                        <div className={styles.earn_text}>
                            <h2>Take survey, Earn money</h2>
                            <div className={styles.earn_info}>
                            ...
                            <a href="https://www.murmurcars.com/" className={styles.create_champ_btn}>Download our app 
                    ...
                    <Col md="6" xs="12">
                        <img src={Earn_Money} alt="" class={styles.earn_img}/>
                    </Col>
                </Row>
            </Container>
        </section>
        <section className={styles.how_works}>
            <h2 className={styles.title_h2}>How does it work?</h2>
            <div className={styles.main_sub_txt}>
                We help any businesses to target their audiences where they go. Reach local audiences and drive results more effectively Build awareness, acquire, convert, increase sales
            </div> 
            <Container className={styles.works_container}>
                <Row>
                    <Col md="3" xs="12">
                        <div className={styles.survey_item}>
                            <div className={styles.survey_item_img}><img src={Download} alt="" /></div>
                            <h4>Download app</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Porttitor amet ut sed nunc malesuada lobortis.</p>
                        </div>
                    </Col>
                    <Col md="3" xs="12">
                        <div className={styles.survey_item}>
                            <div className={styles.survey_item_img}><img src={Receive} alt="" /></div>
                            <h4>Receive survey</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Porttitor amet ut sed nunc malesuada lobortis.</p>
                        </div>
                    </Col>
                    <Col md="3" xs="12">
                        <div className={styles.survey_item}>
                            <div className={styles.survey_item_img}><img src={Answer} alt="" /></div>
                            <h4>Answer</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Porttitor amet ut sed nunc malesuada lobortis.</p>
                        </div>
                    </Col>
                    <Col md="3" xs="12">
                        <div className={styles.survey_item}>
                            <div className={styles.survey_item_img}><img src={Money} alt="" /></div>
                            <h4>Earn money</h4>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Porttitor amet ut sed nunc malesuada lobortis.</p>
                        </div>
                    </Col>
        ...
        <section className={styles.works}>
            <img src={Surveybg1} alt="" className={styles.survey_bg_img} />
            <img src={Surveybg2} alt="" className={styles.survey_bg_img} />
            <img src={Surveybg3} alt="" className={styles.survey_bg_img} />
            <Container className={styles.works_container}>
                <div className={styles.works_rows}>
                    <Row className={styles.works_row}>
                        <Col md="6" xs="12">
                        ...
                        <Col md="6" xs="12">
                            <div className={styles.phone_info}>
                                ...
                                <h4>Mollis quam nibh dictum at auctor.</h4>
                                <p>We help any businesses to target their audiences where they go. Reach local audiences and drive results more effectively Build awareness, acquire, convert, increase sales</p>
                            </div>
                        </Col>
                    </Row>
                    <Row className={styles.works_row}>
